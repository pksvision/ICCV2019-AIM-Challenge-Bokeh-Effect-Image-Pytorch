from models import Bokeh_Generator
import torch
...
checkpoint = torch.load(os.path.join(CHECKPOINTS_DIR,'netG_'+ str(testing_epoch)+".pth"))
...
if __name__ =='__main__':
    ...
    # m= "6.png"
        ...
        h_old,w_old,c_old=img_copy.shape
        ...
        res = cv2.resize(res, (w_old, h_old), interpolation=cv2.INTER_CUBIC)
